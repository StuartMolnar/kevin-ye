    ...
    <div>
      ...
      <main className="min-h-screen font-normal text-black bg-white font-poppins text-body pt-[185px]">
        ...
        <section className="flex">
          <img src="/services/strength-training-hero.jpg" alt="" className="object-cover w-3/5 max-h-[40vw]" />
          <div className="flex flex-col items-center justify-center w-full">
            <div className="flex flex-col max-w-[750px] px-20">
        ...
        <section className="flex flex-col items-center pt-[90px]">
          ...
          <div className="grid items-start grid-cols-2 max-w-[1500px] gap-10 pt-[60px]">
            <div className="flex flex-col col-span-1 p-10">
            ...
            <div className="flex flex-col col-span-1 p-10 bg-gold rounded-[2.5px]">
