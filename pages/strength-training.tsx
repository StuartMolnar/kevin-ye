...
export default function StrengthTraining() {
  ...
  return (
    <div>
      ...
      <main className="min-h-screen font-normal text-black bg-white font-poppins text-body pt-[185px] mt-[60px]">
        ...
        <section id="program-highlights-section" className="flex flex-col items-center pt-[90px]">
          ...
          <div className="grid items-start grid-cols-1 md:grid-cols-2 max-w-[1500px] md:gap-10 pt-[60px]">
            <div className="flex flex-col col-span-1 p-10 pt-0 shadow-lg md:pt-10">
              <img src="/services/avatar-icon.svg" alt="" className="w-[26px] h-[29px]" />
              <p className="font-medium text-header-sub md:text-header-sub-dsk pt-[22px]">Customized Training Plans</p>
              <p className="pt-[18px]">
            ...
            <div className="flex flex-col col-span-1 p-10 pt-0 shadow-lg md:pt-10">
              ...
              <p className="font-medium text-header-sub md:text-header-sub-dsk pt-[22px]">Progressive Resistance Training</p>
              <p className="pt-[18px]">
            ...
            <div className="flex flex-col col-span-1 p-10 pt-0 shadow-lg md:pt-10">
              ...
              <p className="font-medium text-header-sub md:text-header-sub-dsk pt-[22px]">Proper Technique & Form</p>
              <p className="pt-[18px]">
            ...
            <div className="flex flex-col col-span-1 p-10 pt-0 shadow-lg md:pt-10">
              ...
              <p className="font-medium text-header-sub md:text-header-sub-dsk pt-[22px]">Varied Exercise Selection</p>
              <p className="pt-[18px]">
            ...
            <div className="flex flex-col col-span-1 p-10 pt-0 shadow-lg md:pt-10">
              ...
              <p className="font-medium text-header-sub md:text-header-sub-dsk pt-[22px]">Individualized Progress Tracking</p>
              <p className="pt-[18px]">
            ...
            <div className="flex flex-col col-span-1 p-10 pt-0 shadow-lg md:pt-10">
              ...
              <p className="font-medium text-header-sub md:text-header-sub-dsk pt-[22px]">Nutritional Guidance</p>
              <p className="pt-[18px]">
            ...
            <div className="flex flex-col col-span-1 p-10 pt-0 shadow-lg md:pt-10">
              ...
              <p className="font-medium text-header-sub md:text-header-sub-dsk pt-[22px]">Motivation & Accountability</p>
              <p className="pt-[18px]">
